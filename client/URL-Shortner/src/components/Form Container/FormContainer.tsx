    ...
    <div className="container mx-auto p-2">
      <div className="bg-banner my-8 rounded-xl bg-cover bg-center">
        <div className="w-full h-full rounded-xl p-20 backdrop-brightness-50">
          ...
          <p className="text-white text-center text-xl pb-4 font-extralight">
            Paste the URL to be shortened
          </p>
          <p className="text-white text-center pb-4 text-sm font-thin">
            Shrink Link is a free tool to shorten URLs and generate short links
            Shrink Link allows to create a shortened link making it easy to
            share
          </p>
